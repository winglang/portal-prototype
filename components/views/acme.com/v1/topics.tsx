...
import { ChevronDown, ChevronUp, Box, Tag, Globe } from 'lucide-react';
                    ...
                    <CardContent className="p-6">
                        <div className="space-y-6">
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger>
                                            <div className="flex items-center gap-2 bg-gray-100 p-3 rounded-lg">
                                                ...
                                                <code className="bg-gray-200 px-2 py-1 rounded text-gray-800">{obj.topicName}</code>
                                            </div>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger>
                                            <div className="flex items-center gap-2 bg-gray-100 p-3 rounded-lg">
                                                ...
                                                <code className="bg-gray-200 px-2 py-1 rounded text-gray-800">{obj.region}</code>
                                            </div>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>The region of the topic</p>
                                        </TooltipContent>
                                    </Tooltip>
                                )}
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <Collapsible open={showMetadata} onOpenChange={setShowMetadata} className="pl-6">
                                    <CollapsibleTrigger />
                                    <CollapsibleContent className="space-y-2 animate-fadeIn">
                                ...
                                <Collapsible open={showStatus} onOpenChange={setShowStatus} className="pl-6">
                                    <CollapsibleTrigger />
                                    <CollapsibleContent className="space-y-2 animate-fadeIn">
                                        {obj.status?.topicArn && (
                                            <div>Topic ARN: <BalancedBadge color="bg-cyan-100 text-cyan-800">{obj.status.topicArn}</BalancedBadge></div>
                                        )}
