                                    ...
                                    <Tooltip>
                                        <TooltipTrigger>
                                            <div className="flex items-center gap-2 bg-gray-100 p-3 rounded-lg">
                                                ...
                                                <span className="bg-gray-200 px-2 py-1 rounded text-gray-800">{obj.spec.replicas}</span>
                                            </div>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                    ...
                                    <div className="pl-6 space-y-2 animate-fadeIn">
                                        {obj.spec.template.spec.containers[0].env.map((env) => (
                                            <div key={env.name} className="flex items-center gap-2">
                                                ...
                                                <code className="bg-yellow-100 px-2 py-1 rounded text-yellow-800">{env.name}</code>
                                                <span>=</span>
                                                <code className="bg-green-100 px-2 py-1 rounded text-green-800">{env.value}</code>
                                            </div>
                                        ))}
                                    </div>
                                )}
